  ...
  return (
    <div>
      ...
      <div className="flex flex-col items-center">
        ...
        <Image src="/guarding/graduation2024.jpeg" alt="firearms" width={1000} height={1000} />
      ...
      <div className="w-full grid grid-cols-1 md:grid-cols-3 p-2 items-center justify-center">
        {sites.map((site) => (
          <div className="p-4 hover:text-white hover:bg-gold hover:border-gold hover:border-0 key={site} border-2 text-green border-green">
            <h3>{site}</h3>
          </div>
        ))}
      </div>
