  ...
  return (
    <div>
      ...
      <div className="flex flex-col items-center">
        ...
        <Image src="/hero/drone.jpg" alt="control" width={800} height={800} />

      </div>
      <div className="flex flex-col items-center bg-green p-4 gap-2 mb-2">
        <h1 className="text-white">Why work with us?</h1>
        <p className="text-white">At our company, we take immense pride in delivering top-class guarding services that ensure the utmost safety and security for your organization. With years of experience in the industry, we have become the preferred provider for multiple critical governmental organizations and large companies in South Africa. Here's why we stand out from the competition:

          Unparalleled Expertise: With a proven track record of guarding numerous sites, our team has overseen the security operations of a wide range of establishments. We have a wealth of knowledge and experience in safeguarding properties and ensuring the safety of our clients.

          Highly Trained Guards: Our guarding services feature a team of extensively trained and skilled security officers. We offer both unarmed and armed guards, carefully selected for their professionalism, integrity, and ability to handle any security situation with utmost professionalism and efficiency.

          Comprehensive Site Patrolling: Our guards diligently patrol the designated sites to maintain a visible security presence and deter potential threats. We prioritize thorough site inspections and employ proactive strategies to identify and address vulnerabilities promptly.

          State-of-the-Art Control Room: Our operational control room operates 24/7, providing real-time monitoring and support for all our security personnel. This ensures seamless communication, swift response to emergencies, and effective coordination of security measures.

          Adaptable Security Solutions: We understand that the world is constantly changing, and criminal organizations evolve their tactics. Our company stays ahead of the curve, continuously adapting our strategies and investing in cutting-edge technology to provide you with an edge over potential threats.

          Trusted by Governmental Organizations and Large Companies: Our commitment to excellence has earned us the trust and preference of critical governmental organizations and prominent businesses in South Africa. We are proud to have been chosen as the trusted security provider for their vital operations.

          When it comes to ensuring the safety and security of your organization, choose a guarding service that combines unparalleled expertise, highly trained guards, comprehensive site patrolling, a state-of-the-art control room, adaptability, and the trust of key governmental organizations and large companies.</p>
      </div>
      ...
      <div>
        <div className="p-4">
          <h1 className="text-center md:text-left">Why Choose Us</h1>
          ...
          <div className='w-full flex flex-col gap-4 md:flex-row items-center justify-center '>
            ...
            <div className="w-2/3"><h3 className="text-center md:text-left">Trusted by Governmental Organizations and Large Companies</h3>
              <p className="text-center md:text-left">Our commitment to excellence has earned us the trust and preference of critical governmental organizations and prominent businesses in South Africa. We are proud to have been chosen as the trusted security provider for their vital operations.
                ...
                When it comes to ensuring the safety and security of your organization, choose a guarding service that combines unparalleled expertise, highly trained guards, comprehensive site patrolling, a state-of-the-art control room, adaptability, and the trust of key governmental organizations and large companies.</p></div>
          </div>
        </div>
      ...
      <div className="w-full grid grid-cols-1 md:grid-cols-3 p-2 items-center justify-center">
        {sites.map((site) => (
          <div key={site} className="p-4 hover:text-white hover:bg-gold hover:border-gold hover:border-0 key={site} border-2 text-green border-green">
            <h3>{site}</h3>
          </div>
        ))}
      </div>
