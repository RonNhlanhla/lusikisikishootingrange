  ...
  return (
    <div>
      ...
      <div className="w-full flex flex-col py-2">
        <h1>Our Courses</h1>
        <p className="py-2">At Lusikisiki Hardcore Shooting Range, we offer a wide range of courses to help you develop the skills you need to succeed in the field. Our courses are designed to be both challenging and engaging, and we provide the support you need to succeed.</p>
      ...
      <div className="w-full flex items-center justify-center">
        <Image src="/training/security_guard.jpg" alt="control" width={1000} height={1000} className="items-center" />
      </div>
